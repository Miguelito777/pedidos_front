...
/*----------------------------------------EMPLEO-------------------------------------*/
  init(): Observable<any>{
    return this.http.get<any>(this.getURL(this.appSettings.restApiServiceBaseUri,'Login/init'))
    .pipe(
      catchError(this.handleError('getHeroes', []))
    );
  }
  buscarUsuarioOAUTH(usuario): Observable<any>{
    return this.http.post<any>(this.getURL(this.appSettings.restOAUTH,'Login/buscarUsuarioOAUTH'),usuario)
    .pipe(
      catchError(this.handleError('getHeroes', []))
    );
  }
  getSexos(usuario): Observable<any>{
    return this.http.post<any>(this.getURL(this.appSettings.restOAUTH,'Catalogos/getSexo'),usuario)
    .pipe(
      catchError(this.handleError('getHeroes', []))
    );
  }
  getEstadosCivil(usuario): Observable<any>{
    return this.http.post<any>(this.getURL(this.appSettings.restOAUTH,'Catalogos/getEstadosCivil'),usuario)
    .pipe(
      catchError(this.handleError('getHeroes', []))
    );
  }
  registrarPersona(usuario): Observable<any>{
    return this.http.post<any>(this.getURL(this.appSettings.restOAUTH,'Login/registrarUsuarioEmpleo'),usuario)
    .pipe(
      catchError(this.handleError('getHeroes', []))
    );
  }
  confirmarCorreo(token): Observable<any>{
    return this.http.post<any>(this.getURL(this.appSettings.restOAUTH,'Login/confirmarCorreoEmpleo/'+token),{})
    .pipe(
      catchError(this.handleError('confirmarCorreoEmpleo', undefined))
    );
  }
